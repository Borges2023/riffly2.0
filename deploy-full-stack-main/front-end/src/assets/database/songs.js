/**
 * 🎵 Riffly v1.1 - Database de Músicas com suporte a Áudio Local
 * 
 * Sistema de Carregamento de Áudio:
 * - URL local: "/audio/nomedoarquivo.mp3" (prioridade alta)
 * - Fallback remoto: S3 AWS (prioridade média)
 * - Última tentativa: YouTube (prioridade baixa)
 * 
 * 📌 IMPORTANTE: Todos os áudios estão HABILITADOS e COMENTADOS!
 * 
 * Fluxo de Funcionamento:
 * 1. Quando um usuário clica em uma música, o PlayerNew.jsx tenta carregar o áudio
 * 2. Se o arquivo local não existir, usa o fallback remoto (S3)
 * 3. Se S3 falhar, tenta YouTube
 * 4. Anúncios são exibidos para usuários FREE em 2 momentos:
 *    - Ao atingir 30% da música durante a reprodução
 *    - Ao final da música
 */

export const songsArray = [
  {
    // ✅ HENRIQUE & JULIANO - SERTANEJO/UNIVERSITÁRIO
    image: "https://i.scdn.co/image/ab67616d00001e022774b00531d558bc19e12a24",
    name: "Última Saudade - Ao Vivo",
    duration: "02:30",
    artist: "Henrique & Juliano",
    audio: "/audio/ultima-saudade.mp3", // 🎵 Carregamento LOCAL
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/ultima-saudade.mp3", // Fallback S3
    id: 1,
    premium: false, // Disponível para FREE e PREMIUM
    genre: "Sertanejo", // Campo adicional para filtros futuros
    explicit: false,
  },
  {
     ...
     premium: false,},
  {
    // ✅ ANA - Único arquivo MP3 existente na pasta
    image: "https://i.scdn.co/image/ab67616d00001e02af41105c5cd91b28f2cf219d",
    name: "Xonei",
    duration: "02:34",
    artist: "Ana",
    audio: "/audio/Ana.mp3.mpeg", // 🎵 Arquivo REAL (Ana.mp3.mpeg)
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/xonei.mp3", // Fallback
    id: 2,
    premium: false,
    genre: "Funk/Pop",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Hit do youtube
    image: "https://i.scdn.co/image/ab67616d00001e02af41105c5cd91b28f2cf219d",
    name: "Xonei",
    duration: "02:34",
    artist: "Henrique & Juliano",
    audio: "/audio/xonei.mp3", // Local
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/xonei.mp3", // S3
    id: 3,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Clássico sertanejo
    image: "https://i.scdn.co/image/ab67616d00001e02656f8291d741ad247ef330fe",
    name: "Paredões",
    duration: "02:55",
    artist: "Henrique & Juliano",
    audio: "/audio/paredoes.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/paredoes.mp3",
    id: 4,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Música ao vivo
    image: "https://i.scdn.co/image/ab67616d00001e022774b00531d558bc19e12a24",
    name: "Amigo Da Minha Saudade - Ao Vivo",
    duration: "02:30",
    artist: "Henrique & Juliano",
    audio: "/audio/amigo-minha-saudade.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/amigo-minha-saudade.mp3",
    id: 5,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Track sertanejo
    image: "https://i.scdn.co/image/ab67616d00001e022774b00531d558bc19e12a24",
    name: "Seja Ex - Ao Vivo",
    duration: "03:12",
    artist: "Henrique & Juliano",
    audio: "/audio/seja-ex.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/seja-ex.mp3",
    id: 6,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Performance ao vivo
    image: "https://i.scdn.co/image/ab67616d00001e0299c540c0f78793fcea84a920",
    name: "De Trás Pra Frente - Ao Vivo",
    duration: "02:43",
    artist: "Henrique & Juliano",
    audio: "/audio/de-tras-pra-frente.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/de-tras-pra-frente.mp3",
    id: 7,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Balada sertaneja
    image: "https://i.scdn.co/image/ab67616d00001e0299c540c0f78793fcea84a920",
    name: "Aquela Pessoa - Ao Vivo",
    duration: "02:46",
    artist: "Henrique & Juliano",
    audio: "/audio/aquela-pessoa.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/aquela-pessoa.mp3",
    id: 8,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Romântica
    image: "https://i.scdn.co/image/ab67616d00001e0299c540c0f78793fcea84a920",
    name: "Meu Amor - Ao Vivo",
    duration: "02:54",
    artist: "Henrique & Juliano",
    audio: "/audio/meu-amor.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/meu-amor.mp3",
    id: 9,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Melódica
    image: "https://i.scdn.co/image/ab67616d00001e025bb6668a856035550a66fc31",
    name: "Como É Que A Gente Fica - Ao Vivo",
    duration: "02:43",
    artist: "Henrique & Juliano",
    audio: "/audio/como-fica.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/como-fica.mp3",
    id: 10,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ HENRIQUE & JULIANO - Clássico do duo
    image: "https://i.scdn.co/image/ab67616d00001e022774b00531d558bc19e12a24",
    name: "Romântico - Ao Vivo",
    duration: "03:03",
    artist: "Henrique & Juliano",
    audio: "/audio/romantico.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/romantico.mp3",
    id: 11,
    premium: false,
    genre: "Sertanejo",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - FUNK PAULISTA
    image: "https://i.scdn.co/image/ab67616d00001e02d8bfb4567b1b5e5bc4da915b",
    name: "Oh Garota Eu Quero Você Só Pra Mim",
    duration: "02:46",
    artist: "MC Tuto",
    audio: "/audio/oh-garota.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/oh-garota.mp3",
    id: 12,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Track funk famoso
    image: "https://i.scdn.co/image/ab67616d00001e02f412f43fad4c3ffab163287c",
    name: "Barbie",
    duration: "03:12",
    artist: "MC Tuto",
    audio: "/audio/barbie.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/barbie.mp3",
    id: 13,
    premium: false,
    genre: "Funk",
    explicit: false,
  },
  {
    ...
    duration: "03:13",
    artist: "MC Tuto",
    audio: "/audio/do-job.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/do-job.mp3",
    id: 14,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Funk com tom humorístico
    image: "https://i.scdn.co/image/ab67616d00001e02dc16c0b3939b95e09076ec5e",
    name: "A Danada Me Ligando",
    duration: "04:43",
    artist: "MC Tuto",
    audio: "/audio/danada-ligando.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/danada-ligando.mp3",
    id: 15,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Faixa eletrônica
    image: "https://i.scdn.co/image/ab67616d00001e0299ca4be43858f41a3bad9728",
    name: "2025",
    duration: "02:52",
    artist: "MC Tuto",
    audio: "/audio/2025.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/2025.mp3",
    id: 16,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Curta e rápida
    image: "https://i.scdn.co/image/ab67616d00001e02a8e9382ce68ad5d8758bd998",
    name: "E Aí Como Que Tá ?",
    duration: "02:14",
    artist: "MC Tuto",
    audio: "/audio/como-ta.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/como-ta.mp3",
    id: 17,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Medley energética
    image: "https://i.scdn.co/image/ab67616d00001e022d1affc39c1329a4e3138424",
    name: "THE BOX MEDLEY FUNK 2",
    duration: "04:26",
    artist: "MC Tuto",
    audio: "/audio/box-medley.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/box-medley.mp3",
    id: 18,
    premium: false,
    genre: "Funk",
    explicit: false,
  },
  {
    ...
    duration: "07:04",
    artist: "MC Tuto",
    audio: "/audio/boy-besta.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/boy-besta.mp3",
    id: 19,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Narrativa funk
    image: "https://i.scdn.co/image/ab67616d00001e02700a3fcafbd8498c78f16cb0",
    name: "Vida de Artista",
    duration: "03:16",
    artist: "MC Tuto",
    audio: "/audio/vida-artista.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/vida-artista.mp3",
    id: 20,
    premium: false,
    genre: "Funk",
    explicit: false,
  ...
  {
    // ✅ MC TUTO - Encerramento da playlist
    image: "https://i.scdn.co/image/ab67616d00001e0212d096992d1a94a34672ecd2",
    name: "Mó Fita",
    duration: "04:16",
    artist: "MC Tuto",
    audio: "/audio/mo-fita.mp3",
    audioFallback: "https://jornada-fullstack.s3.us-east-2.amazonaws.com/mo-fita.mp3",
    id: 21,
    premium: false,
    genre: "Funk",
    explicit: false,
...
// Função auxiliar para obter URL de áudio com fallback
export const getAudioUrl = (song) => {
  return song.audio || song.audioFallback || null;
};

// Função para checar se música é premium
export const isPremiumSong = (song) => {
  return song.premium === true;
};
//   {
//     image: "https://i.scdn.co/image/ab67616d00001e02af41105c5cd91b28f2cf219d",
//     name: "Xonei",
